...
<template>
  <Base.Table>
    <tr>
      <td
        valign="top"
        style="padding: 0 0 5px 0 !important"
      >
        <Base.Table width="auto">
          ...
          <tr v-if="isAddonTool('logo')">
            <td style="padding: 0px !important">
              <Addons.Logo td-style="padding: 10px 10px 5px 0 !important;" />
            </td>
          </tr>
        </Base.Table>
      </td>
...
&nbsp;&nbsp;
            ...
            <td :width="options && options.column1Width ? `${96 - options.column1Width}%` : 'auto'">
              <Base.Table width="auto">
                <Main.Field
      ...
      >
        <Base.Table width="100%">
          <tr>
              ...
              <Base.Table width="auto">
                <tr v-if="isAddonTool('videoConference')">
                  <td
                    ...
                    style="padding: 0px !important"
                  >
                    <Addons.VideoConference td-style="padding: 0 !important" />
                  </td>
                </tr>
            ...
            >
              <Main.Social :td-style="{ padding: '0 10px 0 0 !important' }" />
            </td>
          </tr>
        </Base.Table>
      </td>
