      ...
      >
        <Base.Table width="auto">
                ...
                <tr>
                  <td style="padding: 0px !important">
                    <Main.Avatar
                      ...
                      td-style="padding: 0 10px 10px 0 !important"
                    />
                  </td>
                </tr>
                <tr v-if="isAddonTool('logo')">
                  <td style="padding: 0px !important">
                    <Addons.Logo td-style="padding: 0 10px 10px 0 !important" />
                  </td>
                </tr>
              </Base.Table>
            </td>
          ...
          <tr v-if="socials.length">
            <td style="padding: 0px 10px 0 0 !important">
              <Main.Social
        ...
        <Base.Table width="100%">
          ...
          <Main.Field
            ...
            :td-style="{
              ...
              padding: index === 0 ? '5px 0 0 0 !important' : undefined,
            }"
          />
          <tr v-if="isAddonTool('videoConference')">
            <td style="padding: 0px !important">
              <Addons.VideoConference td-style="padding: 5px 0 0 0 !important;" />
            </td>
          </tr>
          ...
          <tr v-if="isAddonTool('cta')">
            <td style="padding: 0px !important">
              <Addons.Cta td-style="padding: 7px 0 0 0 !important;" />
            </td>
          </tr>
